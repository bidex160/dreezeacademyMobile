...
class ClassProvider with ChangeNotifier{
  List<TestModel> goverment = [];
  List<ClassQuestionModel> _classquestion = [
    ClassQuestionModel("What is ur name 1",
    ...
    ClassQuestionModel("What is ur name 2",
        ["Yes","No","dont know"], "No",4, 2, "text",
    "https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4"),

    ClassQuestionModel("What is ur name 3",
        ["Yes","No","dont know"], "Yes",5, 2, "text",
    "https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4"),

    ClassQuestionModel("What is ur name 4",
        ["Yes","No","dont know"], "dont know",6, 2, "dont know",
    "https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4"),

    ClassQuestionModel("What is ur name 5",
  ...
  List<ClassQuestionModel> get items{
